...
// in simple_pos/test/unit/features/inventory/domain/usecases/update_product_usecase_test.dart.
...
class MockProductRepository extends _i1.Mock implements _i3.ProductRepository {
  ...
  @override
  _i4.Future<int> getStock(int? productId) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> updateStock(int? productId, int? newStock) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<bool> productExists(int? id) =>
      (super.noSuchMethod(
